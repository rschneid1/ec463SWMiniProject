					...
					<View>
						<Button
							...
							onPress={()=>
								{
									console.log(email);
									const testRef = usersRef.doc(email).collection('Tests');
									var testSave = 'test';
									usersRef.doc(email).get().then(function(doc) {
										var testNumber = doc.get('testNumber');
										var testNumber = testNumber + 1;
										console.log(testNumber);
										testNumberUpdate.testNumber = testNumber;
										usersRef.doc(email).update(testNumberUpdate);
										testSave = testSave.concat(testNumber);
										console.log(testSave);
										var today = new Date();
										answers.Date = today;
										testRef.doc(testSave).set(answers);
									})
